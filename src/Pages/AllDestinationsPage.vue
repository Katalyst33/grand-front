    ...
    <div class="relative py-20 pt-10 lg:pb-28">
      <div class="relative">
        ...
        <div v-if="destinationStore.isLoaded">
          <div>
            <template v-if="destinationStore.allDestinations.length">
              <div
                  ...
                  >
                    ...
                    <div class="mt-6 flex items-center">
                      ...
                      <div class="flex space-x-2">
                        ...
                        <template
                          v-if="
                            ['staff', 'admin'].includes(appState.user?.role)
                          "
                        >
                          <router-link
                            :to="{
            ...
            <template v-else>
              <div class="flex justify-center py-20">No destination Found</div>
            </template>
          </div>
        </div>
